            ...
            <div class="display-container">
              ...
              <el-form :model="registerForm" :rules="rules" ref="registerForm" label-width="120px">
                <el-form-item label="First Name" prop="userFirstName">
                  <el-input v-model="registerForm.userFirstName"></el-input>
                </el-form-item>
                <el-form-item label="Last Name" prop="userLastName">
                  <el-input v-model="registerForm.userLastName"></el-input>
                </el-form-item>
                ...
                <el-form-item label="User Role" prop="userRole">
                  <el-radio-group v-model="registerForm.userRole">
                    ...
                    <el-radio label="SalesAssistant" >Sales Assistant</el-radio>
                  </el-radio-group>
                </el-form-item>
                <!-- Form action buttons -->
                <el-form-item>
...
export default {
  ...
  data() {
    return {
      registerMessage: 'Register a New User',
      username: "User",
      ...
      rules: {
        ...
        userName: [
          ...
          { min: 4, max: 40, message: 'Username Length should be 2 to 20', trigger: 'blur' }
        ],
        userEmail:[
        ...
        userPassword: [
          ...
          { min: 4, max: 40, message: 'Password Length should be 4 to 20', trigger: 'blur' }
        ],
        userRole: [
    ...
    submitForm() {
      this.$refs['registerForm'].validate((valid) => {
        if (valid) {
          ...
          request.post('/manageaccount/register',this.registerForm).then(res =>{
            if(res.code === '200'){
